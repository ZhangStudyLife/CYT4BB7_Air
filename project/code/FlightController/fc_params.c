...
static void fc_params_fill_defaults(fc_params_t *params)
{
    ...
    /* ===== Pitch 轴角速度环参数 ===== */
    params->pitch_gyro_kp = 5.0f;
    params->pitch_gyro_ki = 0.12f;
    params->pitch_gyro_kd = 0.008f;
