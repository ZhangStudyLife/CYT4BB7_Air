...
static const wifi_params_entry_t s_wifi_params_table[] =
{
    ...
    WIFI_PARAMS_FLOAT_ITEM("pos_x_d_lpf", pos_x_d_lpf, 0.0f, 500.0f),
    ...
    WIFI_PARAMS_FLOAT_ITEM("pos_y_d_lpf", pos_y_d_lpf, 0.0f, 500.0f),
    ...
    WIFI_PARAMS_FLOAT_ITEM("vel_x_d_lpf", vel_x_d_lpf, 0.0f, 500.0f),
    ...
    WIFI_PARAMS_FLOAT_ITEM("mode2_vel_x_kp", mode2_vel_x_kp, 0.0f, 3000.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode2_vel_x_ki", mode2_vel_x_ki, 0.0f, 3000.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode2_vel_x_kd", mode2_vel_x_kd, 0.0f, 3000.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode2_vel_x_kff", mode2_vel_x_kff, 0.0f, 3000.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode2_vel_x_i_limit", mode2_vel_x_i_limit, 0.0f, 5000.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode2_vel_x_d_lpf", mode2_vel_x_d_lpf, 0.0f, 500.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode2_vel_y_kp", mode2_vel_y_kp, 0.0f, 3000.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode2_vel_y_ki", mode2_vel_y_ki, 0.0f, 3000.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode2_vel_y_kd", mode2_vel_y_kd, 0.0f, 3000.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode2_vel_y_kff", mode2_vel_y_kff, 0.0f, 3000.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode2_vel_y_i_limit", mode2_vel_y_i_limit, 0.0f, 5000.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode2_vel_y_d_lpf", mode2_vel_y_d_lpf, 0.0f, 500.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode4_adrc_enable", mode4_adrc_enable, 0.0f, 1.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode4_adrc_log_enable", mode4_adrc_log_enable, 0.0f, 1.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode4_adrc_b0_x", mode4_adrc_b0_x, 1.0f, 100.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode4_adrc_b0_y", mode4_adrc_b0_y, 1.0f, 100.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode4_adrc_td_acc_limit_cmss", mode4_adrc_td_acc_limit_cmss, 0.0f, 500.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode4_adrc_td_jerk_limit_cmsss", mode4_adrc_td_jerk_limit_cmsss, 0.0f, 5000.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode4_adrc_td_brake_acc_limit_cmss", mode4_adrc_td_brake_acc_limit_cmss, 0.0f, 500.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode4_adrc_td_brake_jerk_limit_cmsss", mode4_adrc_td_brake_jerk_limit_cmsss, 0.0f, 5000.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode4_adrc_eso_beta1", mode4_adrc_eso_beta1, 0.0f, 300.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode4_adrc_eso_beta2", mode4_adrc_eso_beta2, 0.0f, 3000.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode4_adrc_eso_alpha1", mode4_adrc_eso_alpha1, 0.01f, 0.99f),
    WIFI_PARAMS_FLOAT_ITEM("mode4_adrc_eso_alpha2", mode4_adrc_eso_alpha2, 0.01f, 0.99f),
    WIFI_PARAMS_FLOAT_ITEM("mode4_adrc_eso_delta_cmps", mode4_adrc_eso_delta_cmps, 0.1f, 100.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode4_adrc_nl_kp", mode4_adrc_nl_kp, 0.0f, 100.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode4_adrc_nl_alpha", mode4_adrc_nl_alpha, 0.01f, 0.99f),
    WIFI_PARAMS_FLOAT_ITEM("mode4_adrc_nl_delta_cmps", mode4_adrc_nl_delta_cmps, 0.1f, 100.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode4_adrc_comp_limit_cmss", mode4_adrc_comp_limit_cmss, 0.0f, 500.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode4_adrc_angle_limit_deg", mode4_adrc_angle_limit_deg, 1.0f, 30.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode4_adrc_output_rate_limit_degps", mode4_adrc_output_rate_limit_degps, 1.0f, 200.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode4_adrc_zero_quiet_cmps", mode4_adrc_zero_quiet_cmps, 0.1f, 50.0f),
