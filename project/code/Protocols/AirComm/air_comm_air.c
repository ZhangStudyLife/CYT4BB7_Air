...
void air_comm_air_init(void)
{
    ...
    AIR_COMM_REGISTER_FLOAT(mode4_vel_x_kp, 0.0f, 3000.0f);
    AIR_COMM_REGISTER_FLOAT(mode4_vel_x_ki, 0.0f, 3000.0f);
    AIR_COMM_REGISTER_FLOAT(mode4_vel_x_kd, 0.0f, 3000.0f);
    AIR_COMM_REGISTER_FLOAT(mode4_vel_x_kff, 0.0f, 3000.0f);
    AIR_COMM_REGISTER_FLOAT(mode4_vel_x_i_limit, 0.0f, 5000.0f);
    AIR_COMM_REGISTER_FLOAT(mode4_vel_x_d_lpf, 0.0f, 500.0f);
    AIR_COMM_REGISTER_FLOAT(mode4_vel_y_kp, 0.0f, 3000.0f);
    AIR_COMM_REGISTER_FLOAT(mode4_vel_y_ki, 0.0f, 3000.0f);
    AIR_COMM_REGISTER_FLOAT(mode4_vel_y_kd, 0.0f, 3000.0f);
    AIR_COMM_REGISTER_FLOAT(mode4_vel_y_kff, 0.0f, 3000.0f);
    AIR_COMM_REGISTER_FLOAT(mode4_vel_y_i_limit, 0.0f, 5000.0f);
    AIR_COMM_REGISTER_FLOAT(mode4_vel_y_d_lpf, 0.0f, 500.0f);
    ...
    AIR_COMM_REGISTER_FLOAT(mode2_adrc_td_brake_acc_limit_cmss, 0.0f, 500.0f);
    AIR_COMM_REGISTER_FLOAT(mode2_adrc_td_brake_jerk_limit_cmsss, 0.0f, 5000.0f);
    ...
    AIR_COMM_REGISTER_FLOAT(mode2_adrc_zero_quiet_cmps, 0.1f, 50.0f);
