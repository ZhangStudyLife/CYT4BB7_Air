...
static const wifi_params_entry_t s_wifi_params_table[] =
{
    ...
    WIFI_PARAMS_FLOAT_ITEM("mode4_vel_x_kp", mode4_vel_x_kp, 0.0f, 3000.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode4_vel_x_ki", mode4_vel_x_ki, 0.0f, 3000.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode4_vel_x_kd", mode4_vel_x_kd, 0.0f, 3000.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode4_vel_x_kff", mode4_vel_x_kff, 0.0f, 3000.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode4_vel_x_i_limit", mode4_vel_x_i_limit, 0.0f, 5000.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode4_vel_x_d_lpf", mode4_vel_x_d_lpf, 0.0f, 500.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode4_vel_y_kp", mode4_vel_y_kp, 0.0f, 3000.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode4_vel_y_ki", mode4_vel_y_ki, 0.0f, 3000.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode4_vel_y_kd", mode4_vel_y_kd, 0.0f, 3000.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode4_vel_y_kff", mode4_vel_y_kff, 0.0f, 3000.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode4_vel_y_i_limit", mode4_vel_y_i_limit, 0.0f, 5000.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode4_vel_y_d_lpf", mode4_vel_y_d_lpf, 0.0f, 500.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode2_vel_x_ff_deg_per_cmps", mode2_vel_x_ff_deg_per_cmps, -1.0f, 1.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode2_vel_y_ff_deg_per_cmps", mode2_vel_y_ff_deg_per_cmps, -1.0f, 1.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode2_adrc_enable", mode2_adrc_enable, 0.0f, 1.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode2_adrc_log_enable", mode2_adrc_log_enable, 0.0f, 1.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode2_adrc_b0_x", mode2_adrc_b0_x, 1.0f, 100.0f),
    ...
    WIFI_PARAMS_FLOAT_ITEM("mode2_adrc_eso_alpha2", mode2_adrc_eso_alpha2, 0.01f, 0.99f),
    WIFI_PARAMS_FLOAT_ITEM("mode2_adrc_eso_delta_cmps", mode2_adrc_eso_delta_cmps, 0.1f, 100.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode2_adrc_nl_kp", mode2_adrc_nl_kp, 0.0f, 100.0f),
    WIFI_PARAMS_FLOAT_ITEM("mode2_adrc_nl_alpha", mode2_adrc_nl_alpha, 0.01f, 0.99f),
