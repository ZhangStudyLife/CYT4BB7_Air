...
extern uint8 g_image_frame[MT9V03X_H][MT9V03X_W];   /* 完整单帧灰度图缓存 */
extern uint8 g_image_binary[MT9V03X_H][MT9V03X_W];  /* 默认二值化图像缓存 */
extern uint8 g_image_threshold;                     /* 默认固定二值化阈值 */
