...
static const float s_mode2_img_fb_limit_cmps = 200.0f;
...
static const float s_mode2_down_proj_x_bias = 0.0f;
static const float s_mode2_down_proj_x_roll_k = 1.408988f;
static const float s_mode2_down_proj_x_pitch_k = 0.015998f;
static const float s_mode2_down_proj_y_bias = -19.863429f;
static const float s_mode2_down_proj_y_roll_k = -0.064165f;
static const float s_mode2_down_proj_y_pitch_k = 1.377711f;
...
static void FC_Mode2_GetDownProjectionCenter(float *cx, float *cy)
{
    *cx = s_mode2_down_proj_x_bias +
          s_mode2_down_proj_x_roll_k * g_euler.roll +
          s_mode2_down_proj_x_pitch_k * g_euler.pitch;
    *cy = s_mode2_down_proj_y_bias +
          s_mode2_down_proj_y_roll_k * g_euler.roll +
          s_mode2_down_proj_y_pitch_k * g_euler.pitch;
}
...
void FC_Mode2_50Hz(float dt)
{
    ...
    {
        FC_Mode2_GetDownProjectionCenter(&down_proj_cx, &down_proj_cy);
    ...
    //              velx_sp,                       /* I13 */
    //              vely_sp,                       /* I14 */
    //              g_mode2_velx_target,           /* I15 */
    //              g_mode2_vely_target,           /* I16 */
    //              s_mode2_accel_x,               /* I17 */
    //              s_mode2_accel_y,               /* I18 */
    ...
    //              g_mode2_velx_pid.p_term,       /* I27 */
    //              g_mode2_velx_pid.i_term,       /* I28 */
    //              g_mode2_velx_pid.d_term,       /* I29 */
    //              g_mode2_velx_pid.output,       /* I30 */
    //              g_mode2_vely_pid.p_term,       /* I31 */
    //              g_mode2_vely_pid.i_term,       /* I32 */
