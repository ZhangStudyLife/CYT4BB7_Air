...
/**
 * 函数功能: 以 1kHz 输入原始 IMU 数据，执行统一的双陷波加低通滤波，
 *           并填充 1000Hz、500Hz、250Hz 三个输出结构体。
 * 输入参数:
