...
/*
 * 更新逻辑（PX4 常见 Mahony 思路）：
 * 1) 陀螺积分提供高频姿态响应
 * 2) 加速度重力方向提供低频纠偏
 * 3) 仅在“低动态 + 近 1g”条件下学习陀螺零偏
 */
                       ...
                       float dt)
{
    ...
    gz = gyro_z * DEGREES_TO_RADIANS - ahrs->gyro_bias_z;
